...
exports.subscriptionsController = {
            ...
            const plans = [
                {
                    id: 'weekly',
                    name: 'Weekly Premium',
                    price: config_1.CONFIG.PREMIUM_WEEKLY_PRICE,
                    currency: 'GHS',
                    duration: '7 days',
                    features: [
                        'Access to rankings',
                ...
                },
                {
                    ...
                    price: config_1.CONFIG.PREMIUM_WEEKLY_PRICE * 4 * 0.85, // 15% discount
                    currency: 'GHS',
                    duration: '30 days',
                    features: [
                        'Access to rankings',
    ...
    getSubscriptionStatus: async (req, res) => {
      ...
      `, [userId]);
            ...
            if (isPremium) {
                const subResult = await database_1.pgPool.query(`
        ...
        `, [userId]);
            ...
            if (isTrial) {
                ...
                trialEndDate.setDate(trialEndDate.getDate() + config_1.CONFIG.TRIAL_PERIOD_DAYS);
                const now = new Date();
