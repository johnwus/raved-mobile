...
class ModerationService {
    ...
    async moderateText(text) {
        try {
            ...
            let severity = 'low';
            if (flaggedCategories.some(cat => ['sexual_minors', 'self_harm', 'violence_graphic'].includes(cat))) {
                severity = 'high';
            }
            else if (flaggedCategories.some(cat => ['hate_threatening', 'sexual', 'violence'].includes(cat))) {
                severity = 'medium';
            }
            return {
