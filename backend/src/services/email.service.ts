...
export class EmailService {
  ...
  private static emailQueue: Queue.Queue;
  ...
  static initialize() {
    ...
    this.emailQueue = new Queue('email-queue', redisUrl);
  ...
  static async sendEmailDirect(emailData: EmailData): Promise<void> {
    try {
      const msg = {
        to: emailData.to,
  ...
  static async sendNotificationEmail(email: string, firstName: string, notification: {
    type: string;
    title: string;
    message: string;
    actorName?: string;
  ...
  private static getVerificationTemplate(firstName: string, token: string): EmailTemplate {
  ...
  private static getPasswordResetTemplate(firstName: string, token: string): EmailTemplate {
  ...
  private static getNotificationTemplate(firstName: string, notification: { type: string; title: string; message: string; actorName?: string }): EmailTemplate {
